...
class MovieFavoritesAdapter internal constructor() :
    PagedListAdapter<MovieEntity, MovieFavoritesAdapter.ViewHolder>(
        DIFF_CALLBACK
    ) {
        ...
        fun bind(movie: MovieEntity) {
            with(binding) {
                ...
                itemView.setOnClickListener {
                    ...
                    intent.putExtra(DetailActivity.EXTRA_FROM, "Movie")
